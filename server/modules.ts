...
export function registryPayloadDigest(registry: CapabilityRegistry): string {
...
export function registryMatchesReviewedPlans(context: ProjectContext, registry: CapabilityRegistry): boolean {
  ...
  if (registry.plans.length !== context.allowedPlanIds.length || registry.digest !== registryPayloadDigest(registry)) return false;
