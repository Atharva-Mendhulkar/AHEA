...
import type { DiagnosisSession, ProjectContext, SimulationFixture } from "../shared/domain.js";
...
export async function setup(fixture: SimulationFixture = "loopback_open", context?: ProjectContext) {
  ...
  const session = await coordinator.createSession("simulation", fixture, context);
