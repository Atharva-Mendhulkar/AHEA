...
constexpr bool PHYSICAL_ENABLED = AHEA_MPU6050_REVIEWED_PROFILE == 1;
constexpr const char* PROFILE_ID = AHEA_MPU6050_REVIEWED_PROFILE == 1 ? "esp32s3-n16r8-mpu6050-reviewed-v1" : "esp32s3-loopback-safe-disabled-v1";
constexpr const char* BOARD_IDENTITY = AHEA_MPU6050_REVIEWED_PROFILE == 1 ? "ESP32-S3-N16R8-CP2102" : "ESP32-S3-N16R8-CP2102-UNREVIEWED";
